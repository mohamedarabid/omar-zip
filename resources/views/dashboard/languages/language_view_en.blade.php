...
card card-docs mb-2">
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <form class="form-horizontal" action="{{ route('languages.key_value_store', app()->getLocale()) }}"
                method="POST">
                @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control value" style="width:100%"
                                        name="key[{{ $key }}]"
                                        @isset(openJSONFile($language)[$key]) value="{{ openJSONFile($language)[$key] }}" @endisset>
                                </td>
                            </tr>
                            @php
                                $i++;
