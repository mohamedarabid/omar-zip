                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">{{ __('name type') }}</h5>
...
@section('scripts')
    ...
    <script>
        function performStore() {
            ...
            store('/dashboard/admin/type-milestones', formData)
            location.reload();
        ...
        function performUpdate(id) {
            ...
            update('/dashboard/admin/type-milestones/' + id, data);
            location.reload();
