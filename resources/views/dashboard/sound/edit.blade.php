...
@section('page_description', 'edit sound')
    ...
    <div class="card card-custom">
        ...
        <form class="form" method="post" id='create_form'>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="name" value="{{ $sound->name }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="secound_name" value="{{ $sound->secound_name }}"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="code" value="{{ $sound->code }}"
                            class="form-control form-control-solid" placeholder="{{ __('code') }}" />

                    </div>
                    <div class="form-group col-md-6">
                        <label>{{ __('desc') }}:</label>
                        <textarea type="text" id="desc" class="form-control form-control-solid" placeholder="{{ __('desc') }}">{{ $sound->desc }}</textarea>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="url" value="{{ $sound->url }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" id="duration" value="{{ $sound->duration }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                    ...
                                    <input type="hidden" name="image" value="{{ $sound->image }}" id="image"
            ...
            <div class="card-footer">
                ...
                <button type="button" onclick="performUpdate({{ $sound->id }})"
...
@section('scripts')
    ...
    <script>
        ...
        function performUpdate(id) {
            ...
            update('/dashboard/admin/sounds/' + id, data, '/dashboard/admin/sounds');
