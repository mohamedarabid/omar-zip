...
@section('page_description', 'edit scroll')
    ...
    <div class="card card-custom">
        ...
        <form class="form" method="post" id='create_form'>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="name" value="{{ $scroll->name }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="secound_name" value="{{ $scroll->secound_name }}"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="code" value="{{ $scroll->code }}"
                            class="form-control form-control-solid" placeholder="{{ __('code') }}" />

                    </div>
                    <div class="form-group col-md-6">
                        <label>{{ __('desc') }}:</label>
                        <textarea type="text" id="desc" class="form-control form-control-solid" placeholder="{{ __('desc') }}">{{ $scroll->desc }}</textarea>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="url" value="{{ $scroll->url }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" id="duration" value="{{ $scroll->duration }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="category_id">
                            @foreach ($categories as $category)
                                <option @if ($scroll->category_id == $category->id) selected @endif value="{{ $category->id }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="type_id">
                            @foreach ($types as $type)
                                <option @if ($scroll->type_id == $type->id) selected @endif value="{{ $type->id }}">
                                    {{ $type->name }}</option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                    ...
                                    <input type="hidden" name="image" value="{{ $scroll->image }}" id="image"
            ...
            <div class="card-footer">
                ...
                <button type="button" onclick="performUpdate({{ $scroll->id }})"
...
@section('scripts')
    ...
    <script>
        ...
        function performUpdate(id) {
            ...
            update('/dashboard/admin/scrolls/' + id, data, '/dashboard/admin/scrolls');
